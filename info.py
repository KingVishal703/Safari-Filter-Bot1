...
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/c3beb86445e8ac1ed95eb-be2826722d8829677c.jpg') # Scanner Code image 
...
premium = environ.get('PREMIUM_LOGS', '-1002316519762')
...
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "RW7038") # widout 👉 @
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002167105361').split()]
# post channel auto post new movie
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1002111868028').split(','))))
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002111868028'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002111868028'))
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Movies_King_Update_Channel')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002207449255))
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002207449255)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002057941851)) # movies request channel, else log channel
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1002057941851')
